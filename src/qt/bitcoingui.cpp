    ...
    prevBlocks(0)
{
    ...
    setWindowTitle(tr("Realcoin") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About Realcoin"), this);
    aboutAction->setStatusTip(tr("Show information about Realcoin"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Realcoin client"));
...
{
    QString strTitle = tr("Realcoin"); // default title
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            message(tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Realcoin address or malformed URI parameters."),
